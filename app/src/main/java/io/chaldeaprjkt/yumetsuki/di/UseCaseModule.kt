...
import io.chaldeaprjkt.yumetsuki.domain.usecase.RequestCheckInUseCaseImpl
...
abstract class UseCaseModule {
    ...
    @Binds abstract fun bindSyncGameAcc(impl: SyncGameAccUseCaseImpl): SyncGameAccUseCase

    @Binds
    abstract fun bindSyncCheckInStatus(impl: SyncCheckInStatusUseCaseImpl): SyncCheckInStatusUseCase

    @Binds abstract fun bindRequestCheckIn(impl: RequestCheckInUseCaseImpl): RequestCheckInUseCase
}
