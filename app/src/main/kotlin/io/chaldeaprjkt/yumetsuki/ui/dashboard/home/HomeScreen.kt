...
fun NotePrivateDialog(
    ...
    AlertDialog(
        onDismissRequest = onDismissRequest,
        title = { Text(text = stringResource(id = R.string.realtimenote_error_private)) },
        text = {
            Text(
                text = stringResource(id = R.string.realtimenote_makepublic_ask)
            )
        },
        confirmButton = {
            Button(
...
@Composable
fun NotePrivateWarningDialog(onDismissRequest: () -> Unit = {}) {
    AlertDialog(
        onDismissRequest = onDismissRequest,
        title = { Text(text = stringResource(id = R.string.realtimenote_error_private)) },
        text = {
            Text(
                text = stringResource(id = R.string.realtimenote_error_data_private)
            )
        },
        confirmButton = {
            Button(
